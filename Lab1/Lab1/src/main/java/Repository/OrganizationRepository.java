...
public class OrganizationRepository {
    ...
    private final String defaultSelect = "SELECT \"AnnualTurnover\", \"CreationDate\", \"Id\", \"Name\", \"OrganizationType\", x, y, \"PostalAddress\" FROM \"Organization\"";
    private final String insert = "INSERT INTO \"Organization\" (\"AnnualTurnover\", \"Name\", \"OrganizationType\", x, y, \"PostalAddress\") VALUES (?, ?, ?, ?, ?, ?);";
    private final String update = "UPDATE \"Organization\" SET ";
    ...
    public boolean addNewOrganization(String Name, Double x, Long y, Double annualTurnover, Short organizationType, String street) {
    ...
    public void updateOrganization(Integer id, String name, Double x, Long y, Double annualTurnover, String street, Short type) {

        try (PreparedStatement stmt = connection.prepareStatement("UPDATE \"Organization\" SET \"Name\"=?, x=?, y=?, \"AnnualTurnover\"=?, \"PostalAddress\"=?, \"OrganizationType\"=? WHERE \"Id\"=?")) {
